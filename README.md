...
(7 лексических — точные названия процессов, ролей и документов, 7 —
семантические перефразировки; релевантность на уровне документа). Гибридный
...
| FTS (BM25) | 0.73 | 0.55 |
| Гибрид (RRF + расширение запроса) | 0.73 | 0.46 |
